import { Search, Zap, Truck, Shield, Clock, Car, Wrench, Disc3, Battery } from 'lucide-react';
  ...
  return (
    <div>
      ...
      <div className="px-4 py-4">
        ...
        <div className="mt-4 flex flex-col items-center rounded-card border border-dashed border-slate-300 bg-white py-10">
