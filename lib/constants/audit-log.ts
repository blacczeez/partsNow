...
export const AUDIT_ACTIONS = {
  ...
  VENDOR_INCIDENT_CONFIRMED: 'vendor.incident_confirmed',
  VENDOR_INCIDENT_REJECTED: 'vendor.incident_rejected',
  CUSTOMER_PART_ISSUE_REPORTED: 'customer.part_issue_reported',
...
export const ACTION_LABELS: Record<AuditAction, string> = {
  ...
  [AUDIT_ACTIONS.VENDOR_INCIDENT_CONFIRMED]: 'Vendor incident confirmed',
  [AUDIT_ACTIONS.VENDOR_INCIDENT_REJECTED]: 'Vendor incident rejected',
  [AUDIT_ACTIONS.CUSTOMER_PART_ISSUE_REPORTED]: 'Customer reported part issue',
